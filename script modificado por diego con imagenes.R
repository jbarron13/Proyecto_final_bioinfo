...
modelando <- function(){
  ...
  if(p1 == "SI" & p2 == T){  ## LISTO GRF
    i1 <-readJPEG("image_model/SIP.jpeg",native=TRUE) ; plot(0:1,0:1,type="n",ann=FALSE,axes=FALSE) ; rasterImage(i1,0,0,1,1)
    ...
    i2 <-readJPEG("image_model/SIP.jpeg",native=TRUE) ; plot(0:1,0:1,type="n",ann=FALSE, axes=FALSE) ; rasterImage(i1,0,0,1,1)
    ...
    i3 <-readJPEG("image_model/SISP.jpeg",native=TRUE) ; plot(0:1,0:1,type="n",ann=FALSE,axes=FALSE) ; rasterImage(i1,0,0,1,1)
    ...
    i4 <-readJPEG("image_model/SISP.jpeg",native=TRUE) ; plot(0:1,0:1,type="n",ann=FALSE,axes=FALSE) ; rasterImage(i1,0,0,1,1)
    SIS <- function(t,state,parameters){
      with(as.list(c(state, parameters)), {
        dS <- - beta*S*I + gama*I
        dI <- beta*S*I - gama*I
    ...
    i5 <-readJPEG("image_model/SIRP.jpeg",native=TRUE) ; plot(0:1,0:1,type="n",ann=FALSE,axes=FALSE) ; rasterImage(i1,0,0,1,1)
    ...
    i6 <-readJPEG("image_model/SIR.jpeg",native=TRUE) ; plot(0:1,0:1,type="n",ann=FALSE,axes=FALSE) ; rasterImage(i1,0,0,1,1)
    SIR <- function(t,state,parameters){
      with(as.list(c(state, parameters)), {
        dS <- - beta*S*I 
        dI <- beta*S*I - gama*I
    ...
    i7 <-readJPEG("image_model/SIRSP.jpeg",native=TRUE) ; plot(0:1,0:1,type="n",ann=FALSE,axes=FALSE) ; rasterImage(i1,0,0,1,1)
    ...
    i8 <-readJPEG("image_model/SIRS.jpeg",native=TRUE) ; plot(0:1,0:1,type="n",ann=FALSE,axes=FALSE) ; rasterImage(i1,0,0,1,1)
    SIRS <- function(t,state,parameters){
      with(as.list(c(state, parameters)), {
        dS <- - beta*S*I + delta*R
        dI <- beta*S*I - gama*I
    ...
    i9 <-readJPEG("image_model/SEIRP.jpeg",native=TRUE) ; plot(0:1,0:1,type="n",ann=FALSE,axes=FALSE) ; rasterImage(i1,0,0,1,1)
    ...
    i10 <-readJPEG("image_model/SEIR.jpeg",native=TRUE) ; plot(0:1,0:1,type="n",ann=FALSE,axes=FALSE) ; rasterImage(i1,0,0,1,1)
    SEIR <- function(t,state,parameters){
      with(as.list(c(state, parameters)), {
        dS <- - beta*S*I 
        dE <- beta*S*I - delta*E
    ...
    i11 <-readJPEG("image_model/SEIRSP.jpeg",native=TRUE) ; plot(0:1,0:1,type="n",ann=FALSE,axes=FALSE) ; rasterImage(i1,0,0,1,1)
    ...
    i12 <-readJPEG("image_model/SEIRS.jpeg",native=TRUE) ; plot(0:1,0:1,type="n",ann=FALSE,axes=FALSE) ; rasterImage(i1,0,0,1,1)
    SEIRS <- function(t,state,parameters){
      with(as.list(c(state, parameters)), {
        dS <- - beta*S*I + ro*R
        dE <- beta*S*I - delta*I
